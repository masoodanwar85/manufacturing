    ...
    public static function getInvoiceBooksMissingSerialNumbers($params = [])
    {
        ...
        if (in_array($params['bookType'],['TB','SR'])) {
            ...
            $rawSQL = "
                ...
                LEFT JOIN `transaction` ON transactionTypeNumber = CONCAT_WS('-', invoiceBooks.bookType, invoiceBooks.bookNumber, serialNumber.id) AND `transaction`.transactionTypeNumber LIKE '" . $params['bookType'] . "-%'
