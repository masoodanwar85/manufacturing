...
@section('content')
	<div class="card card-default color-palette-box">
		...
		<div class="card-body">
			<form class="form-horizontal" id="frmSales" action="{{ route('stock.multiTransfer') }}" method="POST" onSubmit="return formCheck();">
				@csrf
				<div class="form-group row {{ $errors->has('customerID') ? 'has-error' : '' }}">
					<div class="col-sm-3">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" placeholder="Book Serial #" id="bookSerial" name="bookSerial" class="form-control" value="{{ old('bookSerial')}}" />
                            </div>
                        </div>
                    </div>
				</div>
